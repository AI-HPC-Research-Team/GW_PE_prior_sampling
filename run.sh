...
python3.7 -m inference.gwpe_main train new nde \
    ...
    --model_dir models/GW170104_sample_uniform_100basis_all_posterior_prior/ \  # alpha = 1
    # --model_dir models/GW150914_sample_uniform_100basis_all_uniform_prior/ \  # alpha = 0
    ...
    --nsample 100000 \
    --sampling_from posterior \  # alpha = 1
    # --sampling_from uniform \  # alpha = 0
