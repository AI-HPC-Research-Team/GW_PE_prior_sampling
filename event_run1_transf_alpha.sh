...
python3.7 -m inference.gwpe_main train new nde \
    ...
    --model_dir models/GW150914_sample_uniform_100basis_all_mixed_prior_transfered/ \
...
# train data sampling from mixed (uniform + posterior) with alpha from 1 to 0.005
# for all params dim
