...
python3.7 -m inference.gwpe_main train new nde \
    ...
    --model_dir models/GW151012_sample_uniform_100basis_extrinsic_posterior_prior/ \
...
#     --model_dir models/GW150914_sample_uniform_100basis_extrinsic_posterior_prior/ \
