...
model_path = '/userhome/rerungw/gw150914/'
model_name = sys.argv[1]   #'GW150914_sample_uniform_100basis_all_posterior_prior' # an example
...
for i, event in enumerate(tqdm(event_gps_dict.keys())):
    try:
        data_dir = '/userhome/rerungw/gw150914/data/' + event + '_sample_prior_basis/'        
